      ...
      <div className="p-5 mb-4 bg-light rounded-3">
        <div className="container py-5">
          ...
          <p className="col-md-8 fs-4">
            Benvenuto su booRoad, il portale dedicato agli amanti dell’avventura
            e della scoperta! Qui troverai ispirazione per viaggi
            indimenticabili, itinerari personalizzati e consigli utili per ogni
            destinazione. Esplora nuove culture, paesaggi mozzafiato e
            esperienze autentiche pensate per te.
          </p>
